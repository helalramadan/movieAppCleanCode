...
import 'package:movies_app/core/utils/dummy_details.dart';
    ...
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        if (state.movieDetails == null) {
          // يمكنك إظهار رسالة للمستخدم هنا إذا كانت قيمة movieDetails تساوي null
          return Text('Movie details not available.');
        }

        // القيام ببقية عملية بناء واجهة المستخدم هنا بعد التحقق من صحة قيمة state.movieDetails

        var movie = state.movieDetails!;
        // الاستفادة من movie بشكل آمن هنا
            ...
            (context, index) {
              ...
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: Constant.imageUrl(recommendation.backdropPath!),
